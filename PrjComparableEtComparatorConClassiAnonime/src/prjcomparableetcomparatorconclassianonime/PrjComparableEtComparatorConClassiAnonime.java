 ...
 */
public class PrjComparableEtComparatorConClassiAnonime {
	...
	public static void main(String[] args) {
		...
		//con i comparatori
		//con classe anonima
		Collections.sort(a, new Comparator<Poligono>() {
			@Override
		...
		//con funzioni lambda
		Collections.sort(a, (Poligono p1, Poligono p2) -> Integer.compare(p1.getNumLati(), p2.getNumLati()));
		...
		Collections.sort(a, new Comparator<Poligono>() {
			@Override
			public int compare(Poligono p1, Poligono p2) {
				if (p1.getNumLati() != p2.getNumLati()) {
					return p1.getNumLati() - p2.getNumLati();
				} else {
